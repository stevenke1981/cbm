...
#     -ArtifactName cbm-windows-x64 `
#     -ArchivePath dist\cbm-windows-x64.zip

param(
    [switch]$SkipBuild,
    [switch]$SkipPackage,
    [string]$ArtifactName = "cbm-windows-x64",
    [string]$BinaryPath = "",
    [string]$ArchivePath = "",
    [switch]$SkipMcpSmoke,
...
$Extract = Join-Path $env:TEMP "cbm-smoke-release"
