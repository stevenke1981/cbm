...
The reference `codebase-memory-mcp` project also lists these channels. They are **intentionally deferred** for the Rust rewrite until wrapper maintenance is automated:
